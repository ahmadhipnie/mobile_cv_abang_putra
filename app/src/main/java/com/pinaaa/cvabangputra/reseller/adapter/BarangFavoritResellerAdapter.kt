...
class BarangFavoritResellerAdapter(private val coroutineScope: CoroutineScope, private val databaseRepository: DatabaseRepository) : ListAdapter<DataBarangItem, BarangFavoritResellerAdapter.ViewHolder>(DIFF_CALLBACK) {
