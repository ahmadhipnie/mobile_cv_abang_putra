...
object injection {
    ...
    fun formatDateString(dateString: String, newFormat: String): String {
        val originalFormat = SimpleDateFormat("yyyy/MM/dd mm:HH:ss", Locale.getDefault())
        val targetFormat = SimpleDateFormat(newFormat, Locale.getDefault())
